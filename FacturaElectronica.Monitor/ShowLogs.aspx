<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowLogs.aspx.cs" Inherits="FacturaElectronica.showlogs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Procesamientos del Comprobante</title>
...
<body bgcolor="#6c8eb3">
    ...
    <table style="background-color:#6C8EB3;width:100%">
        <tr>
            ...
            <td align="center">
                <div style="position:absolute;top:50;left:0;width:100%;height:240px;overflow:auto;background-color:#6C8EB3">
                    <asp:GridView ID="gvErrors" runat="server" BackColor="White" 
                        ...
                        HorizontalAlign="Center" AutoGenerateColumns="True" 
                        onrowdatabound="gvErrors_RowDataBound">
                        ...
                        <EmptyDataTemplate >
                            <b>No se encontraron otros procesamientos para este comprobante.</b>
                        </EmptyDataTemplate>
                    </asp:GridView>  
                </div>  
            </td>
