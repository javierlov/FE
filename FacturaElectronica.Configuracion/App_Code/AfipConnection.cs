...
namespace Accendo.ComprobanteElectronico
{
    ...
    public class AfipConnection
    {
        ...
        public string IdServicioNegocio = string.Empty;
        public string RutaCertSigner = string.Empty;
        public bool VerboseMode = DEFAULT_VERBOSE;

        public string ConnectionTicket = string.Empty;
        public string ConnectionErrorDescription = string.Empty;
        ...
        public static void ResetCurrentAfipConnection(string serviceID, Settings oSettings)
        {
            try
            {
                // Si el archivo con info de conexión no existe, lo borro
                string fileName = oSettings.PathConnectionFiles + @"\" + serviceID + ".XML";
        ...
        public void Connect()
        {
            ...
            {
                ConnectionErrorDescription = "Error conectando con la afip: " + noConnection.Message;
                IsConnected = false;
                ConnectionTicket = "";
                strTicketRespuesta = "";
            }
    ...
    class CertificadosX509Lib
    {
        ...
        public X509Certificate2 ObtieneCertificadoDesdeArchivo(string argArchivo)
        {
            ...
            try
            {
                objCert = new X509Certificate2(argArchivo, "");
