...
{
    public partial class SewFacturaLocal : DevExpress.XtraReports.UI.XtraReport
    {
        const string FORMATO_NRO = "{0:#,##0.00}";
        
        public SewFacturaLocal()
        {
            InitializeComponent();
        }
        ...
        private void xrTableCellTotal_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (txtLetraCbte.Text != "B")
                ...
                //xrTableCellTotal.Text = GetFormatedNumber(GetCurrentColumnValue("ImporteSubtotalMonedaFacturacionConIVA").ToString(), "{0:#,##0.00}");
        }
        ...
        private void xrTableCellCantidad_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                xrTableCellCantidad.Text = String.Format(FORMATO_NRO, Convert.ToDecimal(GetCurrentColumnValue("Cantidad").ToString()));
